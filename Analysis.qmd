...
So I am statistically far below the mean—specifically, `r round(my_z_score, 3)` standard deviations away from the mean weight of active males between ages 21–31. This places me in the bottom `r round(pnorm(my_z_score) * 100, 2)`% compared to this baseline group.
